...
// Self-healing create-ATA builder used by the client's token-receiving flows,
// exported for callers assembling their own transaction pipelines.
export { buildRecipientAtaIxs } from './client/resolve';
export type {
  ClientOptions,
